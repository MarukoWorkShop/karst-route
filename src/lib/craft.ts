...
const STOPS: Stop[] = [
  {
    ...
    stay: "Nanning",
    tags: ["culture"],
    beats: ["Airport pickup", "Settle the night before the border", "Brief with your local lead"],
    keep: true,
    route: "both",
  },
  {
  ...
  },
  {
    id: "catba",
    city: "Cat Ba",
    title: "Mong Cai to Cat Ba",
    stay: "Cat Ba",
    tags: ["nature", "photo"],
    beats: ["Mong Cai crossing, handled", "Ferry onto Cat Ba", "Night on the island, not in a lobby"],
    keep: true,
    route: "both",
  },
  {
    ...
    beats: ["Cable to Hai Phong — Vietnamese coffee while you wait", "36 Streets by cyclo", "West Lake after dark"],
    keep: true,
    route: "both",
  },
  {
    ...
    stay: "Hanoi",
    tags: ["food", "culture"],
    beats: ["Ba Dinh in the morning", "Lotus buffet, not a tourist set menu", "Market wander if you want it"],
    keep: false,
    route: "both",
  },
  {
    ...
    beats: ["Road up from Hanoi", "Rice terraces in real light", "Cat Cat village, not a viewpoint-only stop"],
    keep: false,
    route: "both",
  },
  {
    id: "fansipan",
    city: "Overnight train",
    title: "Fansipan, then the meter-gauge",
    stay: "Meter-gauge overnight",
    tags: ["nature", "photo"],
    beats: ["Fansipan cable + Muong Hoa train", "Board the meter-gauge at night", "Sleep on the rails toward China"],
    keep: false,
    route: "r1",
  },
  {
    ...
    stay: "Jianshui",
    tags: ["culture", "photo"],
    beats: ["Exit Vietnam via Hekou", "Private car to Jianshui", "Old town after the border dust"],
    keep: true,
    route: "r1",
  },
  {
  ...
  },
  {
    ...
    stay: "Kunming",
    tags: ["food", "culture"],
    beats: ["Mile to Kunming", "Green Lake and the old street", "Fly out — Dounan flowers if the flight is late"],
    keep: true,
    route: "r1",
  },
  {
...
function stretchSlow(days: Stop[], target: number) {
  ...
  const lingerAfter = new Set(["hanoi-city", "sapa", "friendship"]);
  const out: Stop[] = [];
  let added = 0;
