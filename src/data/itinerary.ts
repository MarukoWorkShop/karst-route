    ...
    days: [
      {
        ...
        stayKind: "hotel",
        placeId: "nanning",
        transport: L("Airport pickup, then a brief city night", "抵达南宁，专车接机／接站，送往酒店"),
        lodging: L("Nanning city hotel", "南宁市区酒店"),
        dining: [
          L("Lunch: depending on arrival", "午餐：不含"),
          L("Dinner: Zhongshan Road or Three Streets & Two Lanes", "晚餐：中山路美食街／三街两巷（时间充裕可选）"),
        ],
        bullets: [L("Night market if time allows", "中山路美食街 · 三街两巷")],
        themes: ["locals", "flavors"],
        blurb: L(
          "Nanning is Guangxi’s capital and China’s gateway toward ASEAN. Settle in, adjust to the climate, and — if you arrive early enough — taste the city’s night markets before the border road begins.",
          "南宁，广西首府，中国面向东盟的门户之城。抵达后入住酒店，适应气候。若时间充裕，可前往中山路美食街感受邕城夜市的热烈。南宁不是终点，而是通往边境与远方的起点。",
        ),
      },
      {
        day: 2,
        ...
        placeId: "halong",
        drive: L(
          "Nanning → Dongxing ~2.5 h · Mong Cai → Ha Long ~3 h",
          "南宁→东兴约 2.5 小时 · 芒街→下龙约 3 小时",
        ),
        transport: L(
          "Nanning → Dongxing (~190 km), cross at Mong Cai (~1–1.5 h), then to Ha Long (~180 km) — ~5.5 h driving total",
          "南宁赴东兴口岸（约 190 公里），通关约 1–1.5 小时，再赴下龙（约 180 公里）；行车约 5.5 小时",
        ),
        lodging: L("Bay-facing hotel in Ha Long", "下龙看湾的酒店"),
        dining: [
          L("Lunch: on the way / after the crossing", "午餐：途中／过关之后"),
          L("Dinner: seafood facing the bay", "晚餐：面朝下龙湾的海鲜"),
        ],
        bullets: [L("Border crossing at Dongxing / Mong Cai", "东兴／芒街口岸通关")],
        themes: ["wild"],
        blurb: L(
          "Leave Nanning for Dongxing, cross into Mong Cai, then drive the coastal road south to Ha Long. One bridge, and the street signs, coffee stalls and colonial façades already feel like another country. Overnight facing the bay — salt air before the islands.",
          "自南宁出发，经东兴口岸过境至越南广宁省芒街市，再沿海岸南下赴下龙。一桥之隔，市井已悄然转换——法式骑楼、越南文招牌、街角炼乳咖啡的甜香。晚间面朝下龙湾入住，先闻海风里的咸味。",
        ),
      },
      {
        day: 3,
        ...
        bullets: [L("Free island time — scooter, beach or kayak", "岛内自由活动（租摩托环岛／沙滩／皮划艇）")],
        themes: ["wild"],
        blurb: L(
          "A short ferry puts you on Cat Ba — the largest island in the Ha Long–Cat Ba World Heritage seascape. Quieter than the mainland town: rent a scooter, kayak the lagoons, or wait for sunset on the sand. The night here is water, not a highway hotel.",
          "乘轮渡从下龙前往吉婆岛——下龙湾—吉婆群岛世界自然遗产的核心岛屿。比下龙市更安静：租摩托环岛、出海皮划艇，或在沙滩静候日落。这一夜是水，不是高速旁的酒店。",
        ),
      },
      {
        day: 4,
        ...
        stayKind: "hotel",
        placeId: "hanoi",
        drive: L("Cable to Hai Phong · road ~2 h to Hanoi", "跨海缆车至海防 · 公路约 2 小时赴河内"),
        transport: L(
          "Cat Ba cable to Hai Phong (~15–20 min), then road to Hanoi (~100 km, ~2 h)",
          "吉婆岛跨海缆车至海防（约 15–20 分钟），再专车赴河内（约 100 公里，约 2 小时）",
        ),
        lodging: L("French-quarter hide near the lake", "湖边法租界小住"),
        dining: [
          L("Lunch: Vietnamese drip coffee stop en route", "午餐：途中滴漏咖啡体验"),
          L("Dinner: Old Quarter street table", "晚餐：古城街头一桌"),
        ],
        bullets: [
          L("St Joseph’s Cathedral", "圣若瑟大教堂"),
          L("Train Street", "火车街"),
          L("36 Streets + cyclo", "三十六古街 · 三轮车"),
          L("West Lake night bus", "观光巴士夜游西湖"),
        ],
        themes: ["flavors", "locals"],
        blurb: L(
          "Cable across the water to Hai Phong, then into Hanoi’s thousand-year capital. Cathedral brick, Train Street’s impossible closeness, a cyclo through the Old Quarter’s one-trade lanes, and a night bus around West Lake when the lights come on.",
          "上午缆车跨越海面前往海防，再入河内千年古都。圣若瑟大教堂的斑驳灰砖、火车街几乎触手可及的铁轨、三十六古街的三轮车巷弄，晚间双层巴士夜游西湖——湖岸灯火与古寺倒影交汇。",
        ),
      },
      {
        day: 5,
        ...
        stayKind: "train",
        placeId: "train",
        drive: L("Overnight metre-gauge · ~8–9 h", "米轨过夜列车 · 约 8–9 小时"),
        transport: L(
          "Hanoi city sights by day; evening soft sleeper Hanoi → Lao Cai (~296 km, dep. ~21:00)",
          "白天河内市内；晚间河内站登上米轨软卧赴老街（约 296 公里，约 21:00 发车）",
        ),
        lodging: L("Soft sleeper on the Yunnan–Vietnam line", "滇越米轨软卧（河内—老街）"),
        dining: [
          L("Lunch: lotus buffet", "午餐：莲花自助餐"),
          L("Dinner: simple meal before boarding", "晚餐：上车前简单一顿"),
        ],
        bullets: [
          L("Ba Dinh Square & Ho Chi Minh Mausoleum", "巴亭广场 · 胡志明陵"),
          L("Free time / Hanoi market", "自由活动／河内菜市场"),
        ],
        themes: ["flavors", "wild"],
        blurb: L(
          "Morning at Ba Dinh and the Mausoleum, lotus buffet at noon, then a market wander if you want the city’s real pulse. At night, board the century-old metre-gauge sleeper up the Red River corridor toward Lao Cai — slow, old, and unlike any hotel.",
          "上午巴亭广场与胡志明陵，中午莲花自助餐，下午可逛河内菜市场。晚间登上百年米轨卧铺，沿河老铁路北上老街——枕着哐当声穿越红河三角洲的夜色，这是一种近乎消逝、却因此独一无二的旅行方式。",
        ),
      },
      {
        day: 6,
        ...
        stayKind: "hotel",
        placeId: "sapa",
        drive: L("Lao Cai → Sapa · ~1 h mountain road", "老街→沙坝 · 盘山约 1 小时"),
        transport: L(
          "Arrive Lao Cai ~06:00; private transfer to Sapa (~35 km, ~1 h)",
          "清晨抵达老街站；专车盘山赴沙坝（约 35 公里，约 1 小时）",
        ),
        lodging: L("Terrace-facing mountain lodge", "看田的山居"),
        dining: [
          L("Lunch: after arrival in Sapa", "午餐：抵达沙坝之后"),
          L("Dinner: highland table", "晚餐：高地一桌"),
        ],
        bullets: [L("Terrace afternoon tea & free time", "梯田下午茶 · 自由修整")],
        themes: ["villages"],
        blurb: L(
          "Wake in Lao Cai — Vietnam’s northwest gate, across the river from China’s Hekou — then climb the mountain road to Sapa at 1,650 m. Mist, terraces, and a slow afternoon tea away from the market bustle.",
          "清晨抵达老街（隔南溪河与中国河口相望），转乘盘山公路约一小时上沙坝。海拔约 1650 米，云雾与梯田包裹山城；下午在梯田景观中用下午茶，把节奏交给缓慢与质朴。",
        ),
      },
      {
        day: 7,
        city: L("Sapa", "沙坝"),
        stay: L("Second night in the clouds", "云上第二夜"),
        stayKind: "hotel",
        placeId: "sapa",
        drive: L("Local transfers · ~1 h total", "当地接驳 · 合计约 1 小时"),
        transport: L(
          "Fansipan cable (~20 min each way) and Cat Cat village transfers",
          "番西邦缆车（单程约 20 分钟）及猫猫村接驳",
        ),
        lodging: L("Same mountain lodge — no packing", "同一山居，不用收行李"),
        dining: [
          L("Lunch: in Sapa or on the mountain", "午餐：沙坝／山上"),
          L("Dinner: highland hot pot", "晚餐：高地热锅"),
        ],
        bullets: [
          L("Fansipan summit (cable + peak)", "番西邦峰（缆车 + 山顶）"),
          L("Cat Cat village", "猫猫村"),
        ],
        themes: ["villages", "wild"],
        blurb: L(
          "Morning for Fansipan — Indochina’s roof at 3,143 m, via one of the world’s longest three-cable rides through cloud and forest. Afternoon in Cat Cat, an old Hmong settlement of stilt houses and a waterfall the French once called CatScat.",
          "上午登番西邦峰（海拔 3143 米，印度支那屋脊），缆车穿越云海与黄连山原始林。下午走猫猫村——沙坝最古老的黑苗聚落之一，吊脚楼依坡而建，瀑布与手工艺仍是日常，不是布景。",
        ),
      },
      {
        day: 8,
        ...
        placeId: "guantang",
        drive: L(
          "Sapa → Hanoi ~5.5–6 h · then to Friendship Pass · ~10 h total",
          "沙坝→河内约 5.5–6 小时 · 全日车程约 10 小时",
        ),
        transport: L(
          "Sapa → Hanoi → Lang Son → Friendship Pass crossing → Longzhou Guantang (~550 km total; pack road snacks)",
          "沙坝返河内，再赴谅山、友谊关出境，转赴龙州观堂（总里程约 550 公里；全程最长行车日，建议备路餐）",
        ),
        lodging: L("Guantang courtyard", "观堂的院子"),
        dining: [
          L("Lunch: on the road / after the pass", "午餐：途中／过关之后"),
          L("Dinner: Zhuang table at the courtyard", "晚餐：院子里的壮家饭"),
        ],
        bullets: [L("Dong Dang fair if in season", "同登庙会（时节恰逢可选）")],
        themes: ["locals", "villages"],
        blurb: L(
          "The longest road day: down from Sapa, across Lang Son, and home through Friendship Pass — one of China’s nine great gates. Overnight at Guantang in Longzhou, a quiet courtyard to settle the border crossing behind you.",
          "全程最长行车日：清晨告别沙坝，经河内转谅山，自友谊关（凭祥口岸）出境回国。当晚入住龙州观堂——壮乡干栏气息的精品小住，让一场跨越海域、平原与高山的越北之旅在关楼之下收束。",
        ),
      },
      {
        day: 9,
        ...
        stayKind: "base",
        placeId: "guantang",
        drive: L("Local · ~1.5 h / ~50 km", "当地约 1.5 小时／约 50 公里"),
        transport: L(
          "Tianqin Zhuang village and sugarcane-sea cycling near Longzhou",
          "天琴壮寨与龙州周边蔗海骑行",
        ),
        ...
        bullets: [
          L("Tianqin music in the Zhuang village", "天琴壮寨 · 天琴弹唱"),
          L("Bicycle through the cane sea", "骑行蔗海"),
          L("Free walk in the border town", "边境小城自由散步"),
        ],
        themes: ["villages", "wild"],
        blurb: L(
          "The second morning belongs to the cane sea — bicycles between the stalks — and Tianqin village, where two strings carry a song older than the border line. No suitcase, no plan beyond the light.",
          "第二天交给蔗海与天琴壮寨——干栏木楼、清亮的天琴，再骑行穿入喀斯特峰林间的甘蔗田。不拎箱子，享受边境小城的慢节奏。",
        ),
      },
      {
        day: 10,
        ...
        placeId: "chongzuo",
        drive: L(
          "Longzhou → Detian ~2 h · Mingshi ~1 h · Nanning ~3 h",
          "龙州→德天约 2 小时 · 明仕约 1 小时 · 南宁约 3 小时",
        ),
        transport: L(
          "Detian Falls (~100 km), Mingshi Pastoral (~35 km), then return to Nanning (~200 km) — ~6 h driving",
          "专车赴德天瀑布（约 100 公里），再赴明仕田园（约 35 公里），晚返南宁（约 200 公里）；行车约 6 小时",
        ),
        lodging: L("Nanning city hotel", "南宁市区酒店"),
        dining: [
        ...
        bullets: [
          L("Detian Falls (bamboo raft)", "德天瀑布（含竹筏）"),
          L("Mingshi Pastoral (raft or cycle)", "明仕田园（竹筏或骑行）"),
        ],
        themes: ["wild"],
        blurb: L(
          "Asia’s greatest cross-border waterfall — Detian on one bank, Ban Gioc on the other — then Mingshi’s quieter karst paddies and bamboo, before the loop closes back in Nanning.",
          "德天瀑布横跨中越，归春河即为国界；水雾扑面，竹筏近岸。再赴明仕田园——峰林、稻田与壮锦日常比阳朔安静得多。晚返南宁入住。",
        ),
      },
      {
        day: 11,
        ...
        stayKind: "hotel",
        transport: L(
          "Hotel to Nanning Wuxu Airport, ~40 min–1 h",
          "酒店送至吴圩机场，约 40 分钟–1 小时",
        ),
        lodging: L("Morning checkout", "早晨退房"),
        dining: [L("Breakfast at the hotel", "酒店早餐")],
        bullets: [
          L("Qingxiu Mountain if time allows", "青秀山（航班时间充裕可选）"),
          L("Ask us for an extra night", "需要加住告诉我们"),
        ],
        themes: ["locals"],
        blurb: L(
          "Transfer to Nanning Wuxu International Airport by flight time. If the schedule allows, a last walk on Qingxiu Mountain — then the eleven-day loop from karst sea to cloud town is complete.",
          "按航班时间前往南宁吴圩国际机场。若时间充裕，可登青秀山远眺，或选芒果干、菠萝蜜干作伴手礼。一场从海上喀斯特到云中山城的十一日纪行，到此落幕。",
        ),
      },
    ],
  },
