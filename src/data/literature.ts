...
export const literaryWorks: LitWork[] = [
  ...
  },
  {
    ...
    title: L("Sapa: In the Mists of Vietnam", "沙巴：在越南的迷雾中"),
    creator: L("Ethnography · photography", "人文纪实 · 摄影集"),
    year: "",
    location: L("Vietnam · Sapa hill station", "越南 · 沙巴高山避暑地"),
    desc: L(
      ...
      "二十世纪初，沙巴被建成法属高山避暑地：1909 年疗养院，1912 年驻军，1920 年河内—老街铁路通车后别墅近三百座。山地居民以苗、瑶、岱、仲等族群为主。沙巴古岩画区自 1997 年起列入越南世界遗产预备名单。",
    ),
