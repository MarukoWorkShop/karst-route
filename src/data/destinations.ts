...
export type PlaceTweak = {
  extraNights: 0 | 1 | 2;
  hotelTier: "simple" | "comfort" | "generous";
};

export const defaultTweak = (): PlaceTweak => ({ extraNights: 0, hotelTier: "comfort" });
...
export const handbooks: Record<RouteId, RouteHandbook> = {
  r1: {
    why: L(
      "You land in Nanning, take the wild north of Vietnam, and fly out of Kunming so Yunnan is the way home — not a second trip.",
      "南宁落地，走完越南北境，再从昆明飞走。云南是回家的路，不是第二趟旅行。",
    ),
    see: L(
      "Detian on the border, Cat Ba limestone, Hanoi’s streets, Sapa terraces, the meter-gauge, Jianshui, Puzhehei’s lakes.",
      "边境德天、吉婆石灰岩、河内的街、沙坝梯田、米轨、建水、普者黑的湖。",
    ),
    play: L(
      "A boat under the falls, a ferry, a cyclo, a night on the rails, a willow-leaf boat at dawn.",
      "瀑布下的船、一班轮渡、一辆三轮、轨上过夜、黎明的柳叶舟。",
    ),
    reviews: [
      {
        id: "r1-us",
        ...
        rating: 4.8,
        quote: L(
          "The border days felt handled, not heroic. Detian and the overnight train were the two I still talk about.",
          "过关像被安排好的，不是冒险故事。德天和米轨过夜，到现在还在讲。",
        ),
        name: "Elena M.",
        from: L("San Francisco, USA", "美国旧金山"),
      },
      {
        id: "r1-uk",
        country: "UK",
        rating: 5,
        quote: L(
          "Two weeks, one car, no buffet-bus energy. Sapa and Puzhehei were the quiet we came for.",
          "两周、一辆车，没有自助餐大巴的味道。沙坝和普者黑才是我们要的静。",
        ),
        name: "James H.",
        from: L("Manchester, UK", "英国曼彻斯特"),
      },
      {
        id: "r1-au",
        country: "AU",
        rating: 4.6,
        quote: L(
          "Flying out of Kunming made the geography click. Wish we’d added one more night in Jianshui.",
          "从昆明走，地理一下子顺了。建水还想再住一晚。",
        ),
        name: "Priya S.",
        from: L("Melbourne, Australia", "澳大利亚墨尔本"),
      },
      {
        id: "r1-fr",
        country: "FR",
        rating: 4.9,
        quote: L(
          "Hanoi was allowed to be a city, not a checklist. The lotus lunch was better than any set menu.",
          "河内被允许成为一座城，不是清单。莲花午餐比任何套餐都好。",
        ),
        name: "Camille R.",
        from: L("Lyon, France", "法国里昂"),
      },
    ],
  },
  r2: {
    why: L(
      "Same wild north, but you close the loop at Friendship Pass and sleep two nights in Longzhou. Families, and anyone who hates a second Chinese airport.",
      "同样野的北境，友谊关闭环，龙州连住两晚。适合家庭，也适合不想换中国机场的人。",
    ),
    see: L(
      "Cat Ba, Hanoi, Sapa, then Tianqin, the cane sea, Detian on the way back to Nanning.",
      "吉婆、河内、沙坝，然后天琴、蔗海，回南宁的路上再看德天。",
    ),
    play: L(
      "A two-night village base, a bicycle in the cane, a waterfall that is not a day-trip from a mega hotel.",
      "村里连住、蔗海骑行、不是从大体量酒店出发的日游瀑布。",
    ),
    reviews: [
      {
        id: "r2-us",
        ...
        rating: 4.7,
        quote: L(
          "Ending where we started saved a domestic flight and a mood. The Tianqin night was the surprise.",
          "在起点结束，少了一段国内航班，也少了一层烦。天琴那晚是意外之喜。",
        ),
        name: "Noah P.",
        from: L("Austin, USA", "美国奥斯汀"),
      },
      {
        id: "r2-uk",
        country: "UK",
        rating: 4.9,
        quote: L(
          "Ten days was enough. Two nights in Guantang meant the children actually unpacked.",
          "十天刚好。观堂两晚，孩子终于把行李打开了。",
        ),
        name: "Hannah W.",
        from: L("Bristol, UK", "英国布里斯托"),
      },
      {
        id: "r2-au",
        country: "AU",
        rating: 4.5,
        quote: L(
          "Detian on the return felt earned. Not a rush-in, photograph, rush-out.",
          "回来时的德天像是挣来的。不是冲进去拍照再冲走。",
        ),
        name: "Tom K.",
        from: L("Brisbane, Australia", "澳大利亚布里斯班"),
      },
      {
        id: "r2-fr",
        country: "FR",
        rating: 5,
        quote: L(
          "Private car, village kitchen, no shopping stops. This is the loop I will send friends.",
          "专车、村里的厨房、没有购物站。这是我会推给朋友的闭环。",
        ),
        name: "Léa B.",
        from: L("Bordeaux, France", "法国波尔多"),
      },
    ],
  },
};
