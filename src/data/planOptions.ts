...
export const ADD_ONS = [
  ...
  { id: "shopping", label: L("🛍️ Shopping Itinerary", "🛍️ 购物行程") },
...
export const TRANSPORT_PREFS = [
  ...
  { id: "water", label: L("🛳️ Waterway sections", "🛳️ 水路游览优先") },
  { id: "short-drives", label: L("🌙 Fewer long daytime drives", "🌙 减少日间长途") },
  { id: "sleeper", label: L("🚂 Metre-gauge sleeper", "🚂 米轨卧铺体验") },
  { id: "flights", label: L("✈️ Include flight legs", "✈️ 飞段衔接") },
] as const;

export const SPECIAL_EXPS = [
  { id: "craft", label: L("🎨 Craft workshops", "🎨 手工艺体验") },
  { id: "village", label: L("🏘️ Village deep-dives", "🏘️ 深度探访村落") },
  { id: "shop", label: L("🛍️ Free shopping time", "🛍️ 自由购物时间") },
